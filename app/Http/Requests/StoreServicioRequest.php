...
class StoreServicioRequest extends FormRequest
{
    ...
    {
        return $this->user()->hasAnyPermission(['crear-servicios']);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'medico_id' => 'nullable|required_if:categoria,ESPECIALIDAD|string|exists:medicos,usuario_id',
    ...
    public function messages(): array
    {
        return [
            ...
            'medico_id.required_if' => 'El médico es obligatorio cuando la categoría es ESPECIALIDAD.',

...
<template>
    <Head title="Inicio - Clínica Santiago Apóstol" />
                ...
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        <Link :href="route('welcome')" class="flex items-center space-x-2">
                            ...
                            <span class="text-xl font-bold text-indigo-600">Clínica Santiago Apóstol</span>
                        </Link>
                    </div>
        ...
        <footer class="bg-gray-900 text-white py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        <h4 class="text-lg font-semibold mb-4">Clínica Santiago Apóstol</h4>
                ...
                <div class="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
                    <p>&copy; {{ new Date().getFullYear() }} Clínica Santiago Apóstol. Todos los derechos reservados.</p>
                </div>
            </div>
        </footer>
    </div>
